...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//https://github.com/REHANM91/killer91.git\x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/REHANM91/killer91.git]")
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/REHANM91/killer91.git).text
			if basesplit in plr:
				key = basesplit
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 7\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-Rehan \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www. https://github.com/REHANM91/killer91.git\x1b[0m\x1b[1;97m]
