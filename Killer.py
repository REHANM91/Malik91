...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/REHANM91/Malik91.git]")
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/profile.php?id=100089571047916")
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/REHANM91/Malik91.git').text
			if basesplit in plr:
				key = basesplit
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www. https://github.com/REHANM91/Malik91.git\x1b[0m\x1b[1;97m]
